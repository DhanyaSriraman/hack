...
const Response = ({ msg }) => {
  ...
  return (
    <div className="p-3">
      <div
        className="h-fit rounded-lg mt-2 text-sm text-black rounded-bl-none bg-[#BDD1BD] p-3 w-fit ml-0"
...
//   return (
//     <div className="p-3 ">
//       <div className="h-fit rounded-lg mt-2 text-sm text-black rounded-bl-none bg-[#BDD1BD] p-3 w-fit ml-0">
//         {msg}
//       </div>
//     </div>
//   );
